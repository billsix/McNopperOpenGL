...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText(RESOURCE_PATH "/Example37/shader/fullscreen.vert.glsl", &vertexSource);
	glusFileLoadText(RESOURCE_PATH "/Example37/shader/texture.frag.glsl", &fragmentSource);
