...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties *light) {
  ...
  struct MaterialProperties material = {.ambientColor = {0.0f, 1.0f, 1.0f, 1.0f},
                                        .diffuseColor = {0.0f, 1.0f, 1.0f, 1.0f},
  ...
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example19" PATH_SEPERATOR "shader" PATH_SEPERATOR "phong.vert.glsl",
                   &vertexSource);
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example19" PATH_SEPERATOR "shader" PATH_SEPERATOR "phong.frag.glsl",
                   &fragmentSource);
  ...
  glusShapeLoadWavefront(RESOURCE_PATH PATH_SEPERATOR "monkey.obj", &wavefrontObj);
