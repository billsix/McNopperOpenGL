...
GLUSboolean init(GLUSvoid) {
  ...
  struct MaterialProperties material = {.ambientColor = {0.75f, 0.75f, 0.75f, 1.0f},
                                        .diffuseColor = {0.75f, 0.75f, 0.75f, 1.0f},
                                        .specularColor = {1.0f, 1.0f, 1.0f, 1.0f},
  ...
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example24" PATH_SEPERATOR "shader" PATH_SEPERATOR "erode.vert.glsl",
                   &vertexSource);
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example24" PATH_SEPERATOR "shader" PATH_SEPERATOR "erode.frag.glsl",
                   &fragmentSource);
  ...
  // Create perlin noise. The brightness of the texels represents the time to
  // erode. The brighter the texel, the earlier the pixel erodes.
  ...
  glTexImage3D(GL_TEXTURE_3D, 0, image.format, image.width, image.height, image.depth, 0, image.format,
  ...
  // No back face culling by purpose. This allows to look through the eroded
  // sphere.
