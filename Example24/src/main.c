...
GLUSboolean init(GLUSvoid) {
  ...
  struct MaterialProperties material = {
      .ambientColor = {0.75f, 0.75f, 0.75f, 1.0f},
  ...
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example24" PATH_SEPERATOR
  ...
  glTexImage3D(GL_TEXTURE_3D, 0, image.format, image.width, image.height,
               image.depth, 0, image.format, GL_UNSIGNED_BYTE, image.data);
