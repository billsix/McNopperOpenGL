...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText(RESOURCE_PATH "/Example25/shader/phong_textured.vert.glsl", &vertexSource);
	glusFileLoadText(RESOURCE_PATH "/Example25/shader/phong_textured.frag.glsl", &fragmentSource);
