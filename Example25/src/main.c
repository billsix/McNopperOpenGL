...
GLUSboolean init(GLUSvoid) {
  ...
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example25" PATH_SEPERATOR "shader" PATH_SEPERATOR
  ...
  glusWavefrontLoad(RESOURCE_PATH PATH_SEPERATOR "ChessKing.obj", &g_wavefront);
