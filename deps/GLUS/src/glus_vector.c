...
GLUSvoid GLUSAPIENTRY glusVector3Reflectf(GLUSfloat result[3],
  ...
  glusVector3MultiplyScalarf(result, normal,
                             2.0f * glusVector3Dotf(normal, incident));
...
GLUSvoid GLUSAPIENTRY glusVector2Reflectf(GLUSfloat result[2],
  ...
  glusVector2MultiplyScalarf(result, normal,
                             2.0f * glusVector2Dotf(normal, incident));
...
GLUSvoid GLUSAPIENTRY glusVector3Refractf(GLUSfloat result[3],
  ...
  // see http://www.hugi.scene.org/online/coding/hugi%2023%20-%20torefrac.htm
  // for a and b vector. In this implementation, the incident vector points into
  // the interface. So the sings do change.
...
GLUSfloat GLUSAPIENTRY glusVector3Fresnelf(const GLUSfloat incident[3],
  ...
  return R0 +
         (1.0f - R0) * powf(1.0f - glusVector3Dotf(negIncident, normal), 5.0f);
}
...
GLUSfloat GLUSAPIENTRY glusVector2Fresnelf(const GLUSfloat incident[2],
  ...
  return R0 +
         (1.0f - R0) * powf(1.0f - glusVector2Dotf(negIncident, normal), 5.0f);
}
