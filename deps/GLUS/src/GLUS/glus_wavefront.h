...
/**
 * Destroys the wavefront structure by freeing the allocated memory. VBOs, VAOs
 * and textures are not freed.
 *
 * @param wavefront The structure which contains the dynamic allocated wavefront
 * data, which will be freed by this function.
 */
...
glusWavefrontLoadScene(const GLUSchar *filename, GLUSscene *scene);

/**
 * Destroys the wavefront structure by freeing the allocated memory. VBOs, VAOs
 * and textures are not freed.
 *
 * @param scene The structure which contains the dynamic allocated wavefront
 * data, which will be freed by this function.
 */
