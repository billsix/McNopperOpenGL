...
GLUSfloat GLUSAPIENTRY glusComplexAbsolutec(const GLUScomplex *complex) {
  return sqrtf(complex->real * complex->real +
...
GLUSvoid GLUSAPIENTRY glusComplexMultiplyComplexc(GLUScomplex *result,
  ...
  temp.real = complex0->real * complex1->real -
              complex0->imaginary * complex1->imaginary;
  temp.imaginary = complex0->real * complex1->imaginary +
                   complex1->real * complex0->imaginary;
...
GLUSvoid GLUSAPIENTRY glusComplexDivideComplexc(GLUScomplex *result,
  ...
  GLUSfloat divisor = complex1->real * complex1->real +
                      complex1->imaginary * complex1->imaginary;

  temp.real = (complex0->real * complex1->real +
               complex0->imaginary * complex1->imaginary) /
              divisor;
  temp.imaginary = (complex1->real * complex0->imaginary -
                    complex0->real * complex1->imaginary) /
                   divisor;
...
GLUSvoid glusComplexRootOfUnityc(GLUScomplex *result, const GLUSint n,
