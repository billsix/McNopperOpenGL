...
GLUSboolean update(GLUSfloat time) {
  ...
  // Rotate the texture coordinates, so the checker pattern rotates around the
  // texture coordinate origin. Please note, that the pattern rotates CW, as we
  // are not rotating the plane but instead the texture coordinates CCW. As the
  // vertices stay at their positions and the texture coordinates "travel" CCW,
  // the final picture rotates CW.
