...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusFileLoadText(RESOURCE_PATH "/Example20/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText(RESOURCE_PATH "/Example20/shader/phong.frag.glsl", &fragmentSource);
