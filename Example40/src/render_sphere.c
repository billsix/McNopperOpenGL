...
GLUSboolean initSphere(GLUSfloat sphereCenter[4], GLUSfloat sphereRadius, GLUSfloat lightDirection[3])
{
    ...
    glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example40" PATH_SEPERATOR "shader" PATH_SEPERATOR "sphere.vert.glsl", &vertexSource);
    glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example40" PATH_SEPERATOR "shader" PATH_SEPERATOR "sphere.frag.glsl", &fragmentSource);
