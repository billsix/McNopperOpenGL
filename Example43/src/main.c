...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example43" PATH_SEPERATOR "shader" PATH_SEPERATOR "phong_textured.vert.glsl", &vertexSource);
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example43" PATH_SEPERATOR "shader" PATH_SEPERATOR "phong_textured.frag.glsl", &fragmentSource);
