...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties *light) {
  ...
  struct MaterialProperties material = {.ambientColor = {0.8f, 0.8f, 0.8f, 1.0f},
  ...
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example42" PATH_SEPERATOR "shader" PATH_SEPERATOR "phong.vert.glsl",
                   &vertexSource);
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example42" PATH_SEPERATOR "shader" PATH_SEPERATOR "phong.frag.glsl",
                   &fragmentSource);
