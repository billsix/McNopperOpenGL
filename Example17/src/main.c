...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText(RESOURCE_PATH "/Example17/shader/phong_clip.vert.glsl", &vertexSource);
    glusFileLoadText(RESOURCE_PATH "/Example17/shader/phong_clip.frag.glsl", &fragmentSource);
