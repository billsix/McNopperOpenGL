...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText(RESOURCE_PATH "/Example38/shader/simple.vert.glsl", &vertexSource);
    glusFileLoadText(RESOURCE_PATH "/Example38/shader/red.frag.glsl", &fragmentSource);
