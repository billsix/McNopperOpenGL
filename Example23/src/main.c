...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example23" PATH_SEPERATOR "shader" PATH_SEPERATOR "tessellation.vert.glsl", &vertexSource);
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example23" PATH_SEPERATOR "shader" PATH_SEPERATOR "tessellation.cont.glsl", &controlSource);
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example23" PATH_SEPERATOR "shader" PATH_SEPERATOR "tessellation.eval.glsl", &evaluationSource);
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example23" PATH_SEPERATOR "shader" PATH_SEPERATOR "tessellation.geom.glsl", &geometrySource);
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example23" PATH_SEPERATOR "shader" PATH_SEPERATOR "tessellation.frag.glsl", &fragmentSource);
