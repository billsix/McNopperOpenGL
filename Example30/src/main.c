...
GLUSboolean init(GLUSvoid)
{
	...
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example30" PATH_SEPERATOR "shader" PATH_SEPERATOR "fullscreen.vert.glsl", &vertexSource);
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example30" PATH_SEPERATOR "shader" PATH_SEPERATOR "texture.frag.glsl", &fragmentSource);
	...
	glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example30" PATH_SEPERATOR "shader" PATH_SEPERATOR "raytrace.comp.glsl", &computeSource);
