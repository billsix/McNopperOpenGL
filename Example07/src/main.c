...
GLUSboolean init(GLUSvoid) {
  ...
  glusFileLoadText(RESOURCE_PATH PATH_SEPERATOR "Example07" PATH_SEPERATOR
  ...
  // The tangent, bitangent and normal do define the tangent space. They are
  // defined in object space, the inverse brings coordinates back to this
  // tangent space.
  ...
  glusImageLoadTga(RESOURCE_PATH "/res//rock_color.tga", &image);
  ...
  glusImageLoadTga(RESOURCE_PATH "/res/rock_normal.tga", &image);
